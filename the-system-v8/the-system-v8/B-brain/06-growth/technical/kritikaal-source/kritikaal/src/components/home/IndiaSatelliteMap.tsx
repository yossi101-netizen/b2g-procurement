    ...
    <div className="w-full h-full relative">
      ...
      >
        <defs>
          ...
          <linearGradient id="ocean-gradient-india" x1="0%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" stopColor="#4A90E2" />
            <stop offset="100%" stopColor="#2E5F8A" />
          </linearGradient>

          {/* Enhanced glow for India */}
          <filter id="india-glow-satellite" x="-100%" y="-100%" width="300%" height="300%">
          ...
          {/* Green flow gradient */}
          <linearGradient id="green-flow-gradient" x1="0%" y1="0%" x2="100%" y2="0%">
        ...
        <rect width="800" height="600" fill="url(#ocean-gradient-india)" />
        ...
        <Geographies geography={geoUrl}>
          {({ geographies }) =>
            geographies.map((geo) => {
              ...
              // India - highlighted
              if (isIndia) {
                fillColor = "#22c55e"; // Green for India
              }
                ...
                <Geography
                  ...
                  style={{
                    default: {
                      ...
                      strokeWidth: isIndia ? 2 : 0.5,
                      outline: "none",
                      filter: isIndia ? "url(#india-glow-satellite)" : "none",
                      transition: "all 0.3s ease",
                    },
                    hover: {
                      fill: isIndia ? "#16a34a" : isSource ? "#64B5F6" : fillColor,
                      stroke: isIndia ? "#15803d" : "#1B5E20",
                      strokeWidth: isIndia ? 2.5 : 0.7,
                      outline: "none",
                      filter: isIndia ? "url(#india-glow-satellite)" : "none",
                      transition: "all 0.3s ease",
                      cursor: "pointer",
          ...
          >
            ...
            >
              <Line
                from={source.coordinates}
                to={INDIA.coordinates}
                stroke="url(#green-flow-gradient)"
        ...
        <Marker coordinates={INDIA.coordinates}>
          ...
          <motion.circle
            ...
            fill="#22c55e"
            fillOpacity={0.6}
            filter="url(#india-glow-satellite)"
            animate={{
              r: [15, 20, 15],
