  ...
  return (
    <div className="w-full h-full relative">
      ...
      >
        ...
        >
          <defs>
            {/* Enhanced glow filter for India */}
            <filter id="india-glow-enhanced" x="-100%" y="-100%" width="300%" height="300%">
            ...
            {/* Enhanced line glow */}
            <filter id="line-glow-green" x="-50%" y="-50%" width="200%" height="200%">
            ...
            {/* Premium green gradient for flow lines */}
            <linearGradient id="india-flow-gradient" x1="0%" y1="0%" x2="100%" y2="0%">
            ...
            <radialGradient id="marker-gradient-green">
              <stop offset="0%" stopColor="#22c55e" stopOpacity={1} />
              <stop offset="100%" stopColor="#16a34a" stopOpacity={0.8} />
            </radialGradient>

            {/* Premium navy gradient background */}
            <linearGradient id="map-bg-gradient-india" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <rect width="800" height="500" fill="url(#map-bg-gradient-india)" />
              ...
              geographies.map((geo) => {
                ...
                return (
                  <Geography
                    ...
                    stroke={isIndia ? "#16a34a" : "#334155"}
                    strokeWidth={isIndia ? 1.5 : 0.4}
                    style={{
                      default: {
                        fill: isIndia ? "#22c55e" : "#1e293b",
                        stroke: isIndia ? "#16a34a" : "#334155",
                        strokeWidth: isIndia ? 1.5 : 0.4,
                        outline: "none",
                        filter: isIndia ? "url(#india-glow-enhanced)" : "none",
                        transition: "all 0.3s ease",
                      },
                      hover: {
                        fill: isIndia ? "#16a34a" : "#334155",
                        stroke: isIndia ? "#15803d" : "#475569",
            ...
            >
              ...
              >
                <Line
                  from={source.coordinates}
                  to={INDIA.coordinates}
                  stroke="url(#india-flow-gradient)"
              ...
              {[0, 0.33, 0.66].map((offset, dotIndex) => (
                <motion.circle
                  ...
                  animate={{
                    opacity: [0, 1, 1, 0],
                    cx: [source.coordinates[0], INDIA.coordinates[0]],
                    cy: [source.coordinates[1], INDIA.coordinates[1]],
                  }}
                  transition={{
                    duration: 3,
                    repeat: Infinity,
          ...
          {SOURCES.map((source, index) => (
            <Marker key={`source-${index}`} coordinates={source.coordinates}>
              ...
              <motion.circle
                r={5}
                fill="url(#marker-gradient-green)"
                stroke="#ffffff"
                strokeWidth={2}
          ...
          {/* India hub marker with enhanced pulsing effect */}
          <Marker coordinates={INDIA.coordinates}>
            {/* Outermost ripple */}
            <motion.circle
              r={20}
              fill="#22c55e"
            ...
            <motion.circle
              ...
              fill="#22c55e"
              fillOpacity={0.5}
              filter="url(#india-glow-enhanced)"
              animate={{
                r: [12, 16, 12],
          ...
          {/* India label with improved typography */}
          <Marker coordinates={INDIA.coordinates}>
            <motion.text
              textAnchor="middle"
              y={-28}
